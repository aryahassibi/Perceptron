...
class Point():
    def __init__(self):
        ...
        self.mappedx = int(mapx(self.x, -1 ,1, 0, width))
        self.mappedy = int(mapx(self.y, -1, 1, height, 0))
    ...
    def show(self, screen):
        ...
        if self.label == 1:
            draw.circle(screen, (0, 0, 0), (self.mappedx, self.mappedy), 8, 2)
        else:
            draw.circle(screen, (0, 0, 0), (self.mappedx, self.mappedy), 8)
